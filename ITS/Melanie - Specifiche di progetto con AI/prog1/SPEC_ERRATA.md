...
**Stato:** documento vivo — registra le correzioni emerse **dopo** il congelamento della spec
...
Più 5 minori (backoff mancante, MAX_CHARS silenzioso, phone regex permissivo, modello hardcoded, disclaimer nel data model) — tutti risolti. **Tutti i fix B1-B5 + minori sono già applicati e committati** (sessione fix 2026-05-21). Verificato sul codice 2026-05-29: nessuna errata aperta lato bug.
...
- **Nota di coerenza:** [[INCIDENTS]] INC-004 afferma *"la spec §6 indica correttamente subprocess"* — **inesatto**: §6 mostra l'SDK. Da correggere in INC-004.
...
| ERR-08 | Claude via CLI subprocess, non SDK | rivedere §6 + costi/GDPR §7 | ⚠️ decisione da formalizzare |
...
- [[Specifica Tecnica v3 - SpecterAI]] — spec congelata 95/100 (riferimento)
